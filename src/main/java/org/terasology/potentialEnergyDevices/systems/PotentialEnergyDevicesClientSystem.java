...
public class PotentialEnergyDevicesClientSystem extends BaseComponentSystem {
    ...
    public void getItemTooltip(GetItemTooltip event, EntityRef entityRef,
        ...
        event.getTooltipLines().add(new TooltipLine(String.format("Energy: %.0f/%.0f",
                potentialEnergyDeviceComponent.currentStoredEnergy,
                potentialEnergyDeviceComponent.maximumStoredEnergy)));
    }
}
